...
/**
 * Class to take care of Yaml configuration files by providing some additional
 * methods to the standard Bukkit YamlConfiguration class. This class enables
 * more modularity, and contains methods to set new configuration parameters
...
public class CommentedYamlConfiguration extends YamlConfiguration {
    ...
    /**
     * Creates a new CommentedYamlConfiguration object representing one of the
     * plugin's configuration files.
     *
     * @param fileName Name of the configuration file situated in the resource
    ...
    /**
     * Creates a new CommentedYamlConfiguration object representing one of the
     * plugin's configuration files. This constructor takes a plugin resource name
     * that may be different for the file name used on the server.
     *
     * @param fileName           Name of the configuration file situated in the
     *                           resource folder of the plugin.
    ...
    /**
     * Gets a set containing all keys in this section, with only the keys of any
     * direct children, and not their own children. Helper method.
     *
     * @param path
    ...
    /**
     * Gets the requested ConfigurationSection by path. Returns an empty
     * ConfigurationSection if it does not exist.
     *
    ...
    public void set(String path, Object value, String comment) {
        ...
        if (comment != null) {
            ...
            // Insert comment as new value in the file; will be converted back to a comment
            // when saved by the
            // FileManager.
    ...
    /**
     * Sets the specified path to the given value with the given comments (one
     * comment per line).
     *
     * @param path     Path of the object to set.
     * @param value    New value to set the path to.
    ...
    /**
     * Performs a backup of the configuration; the backup simply makes a copy of the
     * file and adds a .bak extension to it.
     *
     * @throws IOException
     */

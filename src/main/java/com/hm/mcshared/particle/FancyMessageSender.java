...
public final class FancyMessageSender {
    ...
    private static final int MINOR_VERSION_NUMBER =
            Integer.parseInt(PackageType.getServerVersion().split("_")[1]);
     ...
     * @throws Exception
     */
    public static void sendHoverableMessage(Player player, String message, String hover, String color)
            throws Exception {
     ...
     * @throws Exception
     */
    public static void sendHoverableCommandMessage(
            Player player, String message, String command, String hover, String color) throws Exception {
    ...
    private static void sendTitlePacket(Player player, String titleJson, String subtitleJson)
        ...
        Object craftPlayer = PackageType.CRAFTBUKKIT
                .getClass(PACKAGE_ENTITY + "." + CLASS_CRAFT_PLAYER)
                .cast(player);
        Object craftHandle = PackageType.CRAFTBUKKIT
                .getClass(PACKAGE_ENTITY + "." + CLASS_CRAFT_PLAYER)
                .getMethod(METHOD_GET_HANDLE)
                .invoke(craftPlayer);
        Object playerConnection = PackageType.MINECRAFT_SERVER
                .getClass(CLASS_ENTITY_PLAYER)
                .getField(FIELD_PLAYER_CONNECTION)
                .get(craftHandle);
        ...
        if (PackageType.getServerVersion().startsWith("1_8_R1")) {
            ...
            parsedMainMessage = PackageType.MINECRAFT_SERVER
                    .getClass(NESTED_CHAT_SERIALIZER)
            ...
            parsedMainMessage = PackageType.MINECRAFT_SERVER
                    .getClass(CLASS_CHAT_BASE_COMPONENT + "$" + NESTED_CHAT_SERIALIZER)
                    .getMethod("a", String.class)
                    .invoke(null, UtilitiesOG.trueogExpand(titleJson, player));
            parsedSubMessage = PackageType.MINECRAFT_SERVER
                    .getClass(CLASS_CHAT_BASE_COMPONENT + "$" + NESTED_CHAT_SERIALIZER)
        ...
        Object packetPlayOutChatMainTitle = ReflectionUtils.getConstructor(
                        PackageType.MINECRAFT_SERVER.getClass(CLASS_PACKET_PLAY_OUT_TITLE),
        ...
        PackageType.MINECRAFT_SERVER
                .getClass(CLASS_PLAYER_CONNECTION)
    ...
    private static void sendChatPacket(Player player, String json, byte type) throws ReflectiveOperationException {
        ...
        if (PackageType.getServerVersion().startsWith("1_8_R1")) {
            // Prior to version 1.8.3.
            parsedMessage = PackageType.MINECRAFT_SERVER
                    .getClass(NESTED_CHAT_SERIALIZER)
                    .getMethod("a", String.class)
        ...
        if (MINOR_VERSION_NUMBER < 12) {
            packetPlayOutChat = PackageType.MINECRAFT_SERVER
                    .getClass(CLASS_PACKET_PLAY_OUT_CHAT)
            ...
            if (MINOR_VERSION_NUMBER < 16) {
                packetPlayOutChat = PackageType.MINECRAFT_SERVER
                        .getClass(CLASS_PACKET_PLAY_OUT_CHAT)
                        .getConstructor(
                                PackageType.MINECRAFT_SERVER.getClass(CLASS_CHAT_BASE_COMPONENT), chatMessageTypeClass)
    ...
    private static String constructHoverableCommandMessageJson(
            String message, String command, String hover, String color) {
        return "{\"text\":\"" + message.replace("\"", "\\\"") + "\","

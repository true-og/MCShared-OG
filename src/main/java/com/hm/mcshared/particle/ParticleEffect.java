...
public enum ParticleEffect {
     ...
     * <li>Only the motion on the y-axis can be controlled, the motion on the x- and z-axis are multiplied by 0.1 when
    ...
    private static boolean isColorCorrect(ParticleEffect effect, ParticleColor color) {
        ...
        return ((effect == SPELL_MOB || effect == SPELL_MOB_AMBIENT || effect == REDSTONE)
                        && color instanceof OrdinaryColor)
                || (effect == NOTE && color instanceof NoteColor);
    }
     ...
     */
    public void display(
            float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range)
     ...
     */
    public void display(
            float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, List<Player> players)
            throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
     ...
     */
    public void display(
            float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, Player... players)
            throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
    ...
    /**
     * Represents the color for effects like {@link ParticleEffect#SPELL_MOB}, {@link ParticleEffect#SPELL_MOB_AMBIENT},
    ...
    public static final class ParticlePacket {
         ...
         */
        public ParticlePacket(
                ParticleEffect effect, Vector direction, float speed, boolean longDistance, ParticleData data)
                throws IllegalArgumentException {
            this(
                    effect,
        ...
        /**
         * Initializes {@link #packetConstructor}, {@link #getHandle}, {@link #playerConnection} and {@link #sendPacket}
         * and sets {@link #initialized} to <code>true</code> if it succeeds
         * <p>
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                ...
                playerConnection = ReflectionUtils.getField(
                        "EntityPlayer", PackageType.MINECRAFT_SERVER, false, "playerConnection");
                sendPacket = ReflectionUtils.getMethod(
                        playerConnection.getType(), "sendPacket", PackageType.MINECRAFT_SERVER.getClass("Packet"));
        ...
        /**
         * Determine if {@link #packetConstructor}, {@link #getHandle}, {@link #playerConnection} and
         * {@link #sendPacket} are initialized
         *
        ...
        public void sendTo(Location center, Player player) throws PacketInstantiationException, PacketSendingException {
            ...
            try {
                ...
                throw new PacketSendingException(
                        "Failed to send the packet to player '" + player.getName() + "'", exception);
            }
        }
         ...
         *
         * @param center Center location of the effect
         * @param range Range in which players will receive the packet (Maximum range for particles is usually 16, but
         *        it can differ for some types)
